...
namespace AgentAPI
{
    public class AgentAPIExceptionMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly IExceptionHandler _exceptionHandler;
        private readonly ILogger<AgentAPIExceptionMiddleware> _logger;

        public AgentAPIExceptionMiddleware(RequestDelegate next, IExceptionHandler exceptionHandler, ILogger<AgentAPIExceptionMiddleware> logger)
        {
