...
namespace VenueAPI.BLL
{
    class SpaceImageProvider : ISpaceImageProvider
    {
        ...
        {
            return await _spaceImageRepo.AddSpaceImagesAsync(base64EncodedVenueImages, venueId, spaceId);
        }
        ...
        {
            return await _spaceImageRepo.DeleteSpaceImagesAsync(spaceImageIds, venueId, spaceId);
        }
    }
}
